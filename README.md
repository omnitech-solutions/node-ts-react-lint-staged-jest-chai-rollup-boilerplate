# Node + React + TS + lint-staged + Jest/Chai + Rollup Boilerplate
...
```bash
git clone git@github.com:omnitech-solutions/node-ts-react-lint-staged-jest-chai-rollup-boilerplate.git YOURFOLDERNAME
cd YOURFOLDERNAME
